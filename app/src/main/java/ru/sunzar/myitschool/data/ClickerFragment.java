...
//        Toast.makeText(this.getActivity(), "Not enough money", Toast.LENGTH_SHORT).show();
//    }
//
//    private void savePref() {
//        mySP = this.getActivity().getPreferences(MODE_PRIVATE);
...
//
//        editor.commit();
//        Toast.makeText(this.getActivity(), "Progress saved", Toast.LENGTH_SHORT).show();
//    }
//
...
//        if (this.getActivity().getPreferences(MODE_PRIVATE).getInt(String.valueOf(SAVE_LEVEL_UPGRADE_ADD_MONEY), 1) != 1) {
//            mySP = this.getActivity().getPreferences(MODE_PRIVATE);
//            int saveInt = mySP.getInt(String.valueOf(SAVE_LEVEL_UPGRADE_ADD_MONEY), 1);
//            levelUpgradeAddMoney = saveInt;
//        }
//
//        if (this.getActivity().getPreferences(MODE_PRIVATE).getInt(String.valueOf(SAVE_LEVEL_UPGRADE_OFFLINE_MONEY), 0) != 0) {
//            mySP = this.getActivity().getPreferences(MODE_PRIVATE);
//            int saveInt = mySP.getInt(String.valueOf(SAVE_LEVEL_UPGRADE_OFFLINE_MONEY), 0);
//            levelUpgradeOfflineMoney = saveInt;
//        }
//
//        if (this.getActivity().getPreferences(MODE_PRIVATE).getInt(String.valueOf(SAVE_OFFLINE_MONEY), 0) != 0) {
//            mySP = this.getActivity().getPreferences(MODE_PRIVATE);
//            int saveInt = mySP.getInt(String.valueOf(SAVE_OFFLINE_MONEY), 0);
//            offlineMoney = saveInt;
//        }
//
//        if (this.getActivity().getPreferences(MODE_PRIVATE).getInt(String.valueOf(SAVE_ADD_MONEY), 1) != 1) {
//            mySP = this.getActivity().getPreferences(MODE_PRIVATE);
//            int saveInt = mySP.getInt(String.valueOf(SAVE_ADD_MONEY), 1);
//            addMoney = saveInt;
//        }
//
//        if (this.getActivity().getPreferences(MODE_PRIVATE).getInt(String.valueOf(SAVE_MONEY), 0) != 0) {
//            mySP = this.getActivity().getPreferences(MODE_PRIVATE);
//            int saveInt = mySP.getInt(String.valueOf(SAVE_MONEY), 0);
//            binding.moneyCount.setText(Integer.toString(saveInt));//h
//        }
//
//        if (this.getActivity().getPreferences(MODE_PRIVATE).getFloat(String.valueOf(SAVE_LEVEL_UPGRADE_OFFLINE_TIME), 10f) != 10f) {
//            mySP = this.getActivity().getPreferences(MODE_PRIVATE);
//            float saveFloat = mySP.getFloat(String.valueOf(SAVE_LEVEL_UPGRADE_OFFLINE_TIME), 10f);
//            offlineTime = saveFloat;
//        }
